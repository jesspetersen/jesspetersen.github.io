package  {
	...
	public class Main extends MovieClip {
		...
		public function redPowHit(): void{
			var dmg:int = randomRange(1, 10);
			trace(String(dmg));
			monster.health -= (20+dmg);
			updateUI();
			if (hero.health <= 0)
			{
				tarnagDie();
		...
		public function greenSwirlHit(): void{
			var heal:int = randomRange(10, 20);
			trace(String(heal));
			hero.health += (10+heal);
			updateUI();
			if (hero.health <= 0)
